...
export default function SignInPrompt({ onSignIn, onDismiss }: SignInPromptProps) {
    return (
        <motion.div
            ...
            className="glass-panel rounded-xl p-6 border border-cyan-500/30 max-w-sm w-full mx-4"
        >
            <div className="text-center">
                ...
                <div className="space-y-3">
                    ...
                    <button
                        onClick={onDismiss}
                        className="w-full text-white/50 hover:text-white/80 text-sm py-2 transition-colors hover:underline"
                    >
                        Maybe later
                    </button>
                </div>
