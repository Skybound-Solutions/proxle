...
async function seedLeaderboard() {
    ...
    for (const supporter of FAKE_SUPPORTERS) {
        ...
        batch.set(ref, Object.assign(Object.assign({}, supporter), { photoURL: null, lastActiveAt: admin.firestore.FieldValue.serverTimestamp() }));
    }
    try {
        await batch.commit();
...
seedLeaderboard();
//# sourceMappingURL=seed_leaderboard.js.map