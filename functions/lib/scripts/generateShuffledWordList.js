...
function optimizeWordList(words, seed, maxIterations = 50) {
...
console.log(`Original word count: ${wordList_1.WORD_LIST.length}`);
const SHUFFLE_SEED = 42069; // Fixed seed for reproducibility
const optimizedList = optimizeWordList(wordList_1.WORD_LIST, SHUFFLE_SEED, 100);
...
//# sourceMappingURL=generateShuffledWordList.js.map